# Valve Developer Community Text Editor Extended v0.1.1
...
- Added a special button that changes links into their template one, e.g. [[Category:...]] -> {{ACategory|...}} (![ReplaceLinks Icon](https://github.com/N0ine/VDCEditorEx/blob/main/VDCEditorEx-v0.1.1/images/toolbar/ReplaceLinks.png))
